...
4. Stores the result in a Python dictionary.
5. Sorts the stocks from highest to lowest return.
6. Identifies the best-performing stock and plots all returns in a bar chart.
...
## Limitations
- Total return is based only on the first and last prices and ignores the path taken between them.
